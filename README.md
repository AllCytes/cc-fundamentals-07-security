...
1. **Install protection**: Run `/EA-install-security`
2. **Test it works**: Run `/EA-test-security`
...
| Command | Purpose |
|---------|---------|
| `/EA-install-security` | Interactive security hook installer |
| `/EA-test-security` | Verify hooks are working |
